            ...
            <div class="card-text">
                <form action="">
                    ...
                    <div class="form-group">
                        ...
                        <a href="#" style="float: right;font-size:12x;">esqueceu senha?</a>
                        <input type="password"
                        class="form-control form-control-sm"
                    ...
                    <div class="Sign">tens conta? <a href="#" style="float: right;font-size:12x;">registe-se</a>
                    </div>
